...
- 版本目标 `v0.35.8+83`，schema 保持 26，继续使用 v0.35.7 已建立的持久私有测试签名，预期可直接覆盖更新。源码准备中；CI、草稿 APK 和真机均未验收。
