...
## 0AAAAAAAAAAAAAAAAAAA. 2026-08-26 · v0.38.13 正文流式与悬浮聊天两级入口热修（IMPLEMENTED / LOCAL VALIDATION PASSED / CI PENDING）
...
3. 版本推进为 `0.38.13+112`，SQLite schema 保持33。新分支 `agent/v03813-overlay-chat-routing-hotfix` 从 v0.38.12 总账 head `c298870` 建立；不修改 main，不合并 Draft PR #33。
