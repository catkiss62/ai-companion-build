...
## 0AAAAAAAAAAAAAAAAAA. 2026-08-26 · v0.38.12 聊天贴底、悬浮跳转与模拟手机真机窄修（IMPLEMENTED LOCALLY / CI & APK PENDING / TRUE DEVICE PENDING）
...
6. 新增 `validate_v03812_chat_scroll_phone_ui_fixes.py`，并更新 v0.38.11 后继兼容断言与工作流版本/分支/APK/草稿Release标识。当前只可写本地实现；Flutter analyze/tests、Kotlin测试、release APK、Actions、SHA与真机结果必须在实际完成后回填。
