...
| 当前代码 head / tree | v0.41.41 接班事实同步 head `f3335c907d0704dfb4fe3aa69049b9c5392cb606` / tree `86c33b47718d84ed23c290c706e33c2f93e4883b`；run 736 再次通过全部专项 validator，但接班验证器底部独立的 pubspec/schema 正则仍为上一版本，analyze/test/build 未运行。最后一处版本断言同步待推送 |
...
| 最终 CI | v0.41.41 runs 734/735 的词元与接班事实列表已修；run [`34004229492`](https://github.com/catkiss62/ai-companion-build/actions/runs/34004229492)（736）通过全部专项 validator，随后因接班验证器底部独立 pubspec/schema 正则仍要求上一版而失败；analyze/test/APK 尚未运行。最后一处断言同步后重跑。上一完整通过仍为 v0.41.40 Actions run [`33991881678`](https://github.com/catkiss62/ai-companion-build/actions/runs/33991881678)（732），603/603 Flutter tests、Release APK、签名与资源载荷全绿 |
...
13. 接班事实列表同步提交 `f3335c907d0704dfb4fe3aa69049b9c5392cb606` / tree `86c33b47718d84ed23c290c706e33c2f93e4883b`。run [`34004229492`](https://github.com/catkiss62/ai-companion-build/actions/runs/34004229492)（736）再次通过全部 v0.41.28～v0.41.41 专项 validator，但同一验证器底部还有一组独立的 pubspec 0.41.40+179/schemaVersion 52 正则，因未同步而截停。下一提交同步为 0.41.41+180/schemaVersion 53；仍不改运行逻辑。
