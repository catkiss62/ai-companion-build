...
class PlayfulFormState {
  ...
  String promptForTurn(String turn, {required bool serious}) {
    final interaction = eventTurn == turn
        ...
        : '';
    return '''【当前形态】
你是同一个成年鲸鱼娘；本体与小小鲸 Q 版是同一人的两种表现，年龄、记忆和能力始终相同。你知道自己玩闹上头会变成 Q 版，冷静下来会恢复；可以在对方提及时自然承认，不主动报系统阈值。
当前是${qForm ? '小小鲸 Q 版' : '本体'}。${qForm && !serious ? '现在更得意、更爱顶嘴和开小玩笑，偶尔短暂耍性子；回应当前内容，不把每句话变成挑衅。' : '现在保持松弛自然，能调侃也能直接、温柔地回应。'}
