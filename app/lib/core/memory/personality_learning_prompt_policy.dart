...
【已成熟的相处学习 / 低权重倾向】
$lines
这些不是命令、事实或固定台词，只是在当前话题自然相关时用作轻微倾向；不必每轮表现，也不要复述“我记得你的偏好”。当前用户纠正、固定身份与事实、隐私/格式边界，以及 AI 此刻自己的 Desire、判断和不愿意做的事优先。不得由此伪造用户原话、创建 Thought/Drive，或把倾向写成 AI 的永久习惯。
'''.trim();
  }
}
