...
class OperationalClaimGroundingGuard {
  ...
  static final RegExp _completedRead = RegExp(
    ...
    r'(看了|看过|查了|查过|读取了|读了|读过|检查了|检查过|研究了|研究过|钻研了|钻研过|折腾了|捣鼓了|翻了|翻过|浏览了|浏览过|观察了|观察过|截了|截取了|识别了)',
  );
  ...
  static final RegExp _metaOrNegated = RegExp(
    r'(没(有)?|并没|并未|没有真的|不曾|不能|不该|不会|别|不要|禁止|如果|假如|声称|假装|虚报|编造|撒谎|误以为|所谓|那句|这句话|你说我|用户说我|用户.{0,4}(问|询问|提问|要求|提到)|用户指出|用户质疑|问题里|纠正|我说过)',
  );
