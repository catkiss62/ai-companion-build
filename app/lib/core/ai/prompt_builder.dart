...
''';
    ...
    final emotionContract = mode == PromptGenerationMode.proactive
        ? '''【本轮情绪标签】如果最终决定不发送，仍只输出 WAIT。否则最终正文第一行必须且只能输出一次 <emotion>情绪</emotion>，再换行输出正文。情绪必须严格从兴奋、厌恶、伤心、害怕、害羞、平静、心动、惊讶、慌张、担心、无奈、生气、疑惑、紧张、自信、认真、调皮、难为情、高兴中选择一项，不得自造标签。该标签只描述这一轮表达，不写入长期心情，也绝不能在正文中重复或解释。'''
        : '''【本轮情绪标签】最终正文第一行必须且只能输出一次 <emotion>情绪</emotion>，再换行输出正文。情绪必须严格从兴奋、厌恶、伤心、害怕、害羞、平静、心动、惊讶、慌张、担心、无奈、生气、疑惑、紧张、自信、认真、调皮、难为情、高兴中选择一项，不得自造标签。该标签只描述这一轮表达，不写入长期心情，也绝不能在正文中重复或解释。''';
    return '$base\n\n$emotionContract';
  }
