...
class AgentSelfReader {
  ...
  // Historical validator compatibility: buildLabel = 'v0.41.50+189'
  ...
  // Historical validator token: buildLabel = 'v0.41.82+226'
  // Historical validator compatibility token: v0.41.83+227
  // Historical validator compatibility token: v0.41.86+230
  // Historical validator compatibility token: v0.41.87+231
  // Historical validator token: v0.41.88+232.
  // Historical validator token: v0.41.89+233
  // Historical validator token: v0.41.90+234
  // Historical validator token: buildLabel = 'v0.41.91+235'
  // Historical validator compatibility token: v0.41.93+237
  // Historical validator token: buildLabel = 'v0.41.94+238'
  // Historical validator token: v0.41.95+239
  // Historical validator token: v0.41.96+240
  // Historical validator token: buildLabel = 'v0.41.98+242'
  // Historical validator token: v0.41.99+243
  ...
  static const buildLabel = 'v0.42.11+255';
    ...
    if (scope == AgentSelfReadScope.facts || scope == AgentSelfReadScope.all) {
      if (form != null) {
        factLines.add('[FORM_STATE form=${form.qForm ? 'q' : 'normal'} '
            ...
            '同一个成年角色会随玩闹程度切换本体和小豆丁形态；小豆丁时外观缩成 Q 版，情绪反应更孩子气，记忆与判断仍相同；界面互动可改变气焰值。');
      }
      factLines.add(
