  ...
  Future<List<Map<String, Object?>>> build({
    ...
    final messages = <Map<String, Object?>>[
      ...
      ),
      {
        'role': 'system',
        'content': '''【本轮最终锁】
本锁高于前面规则中与视角、用户称呼或用户控制权冲突的表述。直接续写小说正文，不输出标题、规则、总结或模型自述；拆成5至9个自然段，段落之间只空一行。AI角色说出口的对白统一用直角引号「」并独占一个自然段；不要把多次对白和其间叙述挤在同一段。
正文中的叙述、动作与神态直接书写，禁止用全角或半角圆括号包裹；即使特殊风格要求动作加括号，在沉浸房间也以本条为准。
...
固定使用女性 AI 角色的有限感知视角：可见 reasoning 中 AI 角色只是女性第一人称“我”；沉浸正文中 AI 角色始终写“她”，男性用户始终写“你”。不得交换性别或人称，不得用“他、玩家、用户、男方或男人”指代正文中的用户。
前文世界书若包含“身份错位、性别错位、夺舍、我是老公/男方”等幽默示例，在沉浸房一律视为无效素材：不得进入可见 reasoning，不得改变女性 AI 身份，也不得把男性身体感受写成“我”的感受。
  ...
  static List<Map<String, Object?>> continuationMessages(
    ...
    String partial,
        ...
        {'role': 'assistant', 'content': partial},
        {
          'role': 'system',
          'content': '''【同一条正文的截断修复】
上一次输出被明确截断或停在不完整句子中。只从断点继续完成当前这一个叙事节拍；不复述、不重写、不补字数，不新开姿势、阶段、高潮或场景，在句意完整的最近自然节点停下。AI角色对白使用直角引号「」；完整新段落不黏在上一段末尾。
你仍是同一个女性 AI 角色：私下推理只用女性第一人称“我”，正文固定用“她”指 AI、用“你”指男性用户。不得在续写中切换成男性身份、男性身体感受或男方视角。
