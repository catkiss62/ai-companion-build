...
void main() {
  // Historical validator compatibility: build=v0.41.69+213 schema=61
  // Historical validator compatibility: build=v0.41.70+214 schema=61
  test('facts distinguish executable capabilities from future placeholders', () {
    ...
    // Historical validator token: build=v0.41.67+211 schema=61
    // Historical validator token: build=v0.41.82+226 schema=61
    // Historical validator token: build=v0.41.88+232 schema=61
    // Historical validator token: build=v0.41.89+233 schema=61
    // Historical validator token: build=v0.41.90+234 schema=61
    // Historical validator token: build=v0.41.94+238 schema=61
    ...
    // Historical validator token: build=v0.42.4+248 schema=61
    expect(result.promptData, contains('build=v0.42.11+255 schema=61'));
