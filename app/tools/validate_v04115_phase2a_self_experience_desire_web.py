...
assert any(version in pubspec for version in (
    "version: 0.41.18+157", "version: 0.41.19+158", "version: 0.41.20+159", "version: 0.41.21+160"
))
...
assert any(label in read("app/lib/core/agent/agent_self_reader.dart") for label in (
    "buildLabel = 'v0.41.18+157'", "buildLabel = 'v0.41.19+158'", "buildLabel = 'v0.41.20+159'", "buildLabel = 'v0.41.21+160'"
))
