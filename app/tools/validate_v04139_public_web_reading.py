...
DISCOVERY_POLICY = (ROOT / "lib/core/autonomy/public_web_discovery_policy.dart").read_text(encoding="utf-8")
...
require(DISCOVERY_POLICY, "adaptiveDailyLimit", "adaptive eight-credit ceiling")
require(DISCOVERY_POLICY, "defaultDailyLimit", "default six-credit budget")
require(DISCOVERY, "budgetLimit", "runtime budget application")
