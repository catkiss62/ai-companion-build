...
assert any(token in parsed["02_daily"] for token in (
    "多个动作/对白段之间空一行",
    "多个动作/台词段之间空一行",
))
assert "多个动作/对白段之间空一行" in parsed["05_intimacy_rendering"]
