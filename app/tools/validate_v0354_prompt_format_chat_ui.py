...
if any(version in pubspec for version in ("version: 0.41.22+161", "version: 0.41.23+162", "version: 0.41.24+163")):
    assert parsed["02_daily"].count(action_heading) == 0
    assert parsed["02_daily"].count(pure_dialogue_heading) == 1
    assert "【普通聊天与沉浸分流】" in parsed["02_daily"]
else:
...
if not any(version in pubspec for version in ("version: 0.41.22+161", "version: 0.41.23+162", "version: 0.41.24+163")):
