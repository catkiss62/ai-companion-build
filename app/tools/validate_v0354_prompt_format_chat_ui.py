...
if any(version in pubspec for version in ("version: 0.41.22+161", "version: 0.41.23+162")):
...
if not any(version in pubspec for version in ("version: 0.41.22+161", "version: 0.41.23+162")):
