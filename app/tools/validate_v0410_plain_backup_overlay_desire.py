...
assert re.search(r"^version:\s*0\.41\.(?:0\+139|1\+140|2\+141|3\+142)\s*$", pubspec, re.M)
simple_file_backup = re.search(r"^version:\s*0\.41\.(?:2\+141|3\+142)\s*$", pubspec, re.M) is not None
...
assert "DriveKey.attachment: 0.002 + result.score * 0.004" in presence
