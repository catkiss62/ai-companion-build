...
assert re.search(r"^version:\s*0\.41\.(?:0\+139|1\+140|2\+141|3\+142|4\+143|5\+144|6\+145|7\+146|8\+147|9\+148)\s*$", pubspec, re.M)
simple_file_backup = re.search(r"^version:\s*0\.41\.(?:2\+141|3\+142|4\+143|5\+144|6\+145|7\+146|8\+147|9\+148)\s*$", pubspec, re.M) is not None
