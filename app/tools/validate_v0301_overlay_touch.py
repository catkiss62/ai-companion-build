...
def main() -> int:
    ...
    assert any(v in pubspec for v in ['version: 0.30.1+37', 'version: 0.30.2+38', 'version: 0.30.3+39', 'version: 0.31.0+40'])
    ...
    handoff_tokens += (['v0.31.0+40', 'Grounded Desire Core']
                       if 'version: 0.31.0+40' in pubspec
