...
def main() -> None:
    ...
    require(
        re.search(
            r"^version:\s*(?:0\.41\.62\+206|0\.41\.63\+207|0\.41\.64\+208|0\.41\.65\+209|0\.41\.66\+210|0\.41\.67\+211|0\.41\.68\+212|0\.41\.69\+213|0\.41\.70\+214|0\.41\.71\+215|0\.41\.72\+216|0\.41\.73\+217)\s*$",
            pubspec,
            re.MULTILINE,
        )
        is not None,
