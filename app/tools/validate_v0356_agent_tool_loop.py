...
assert re.search(r"^version: (?:0\.35\.(?:6\+81|7\+82|8\+83|9\+84)|0\.36\.(?:0\+85|1\+86|2\+87|3\+88)|0\.37\.0\+89|0\.37\.1\+90|0\.37\.2\+91|0\.37\.3\+92|0\.37\.4\+93)$", read("pubspec.yaml"), re.MULTILINE)
