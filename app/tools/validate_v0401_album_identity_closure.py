...
assert re.search(r"^version:\s*0\.40\.(?:1\+129|2\+130|3\+(?:131|132)|4\+133|5\+134|6\+135|7\+136)\s*$", pubspec, re.M) or "version: 0.40.10+139" in (Path(__file__).resolve().parents[1] / "pubspec.yaml").read_text()
