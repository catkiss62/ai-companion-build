...
assert any(version in pubspec for version in (
    "version: 0.41.18+157", "version: 0.41.19+158", "version: 0.41.20+159", "version: 0.41.21+160", "version: 0.41.22+161", "version: 0.41.23+162"
))
...
assert any(label in self_reader for label in (
    "buildLabel = 'v0.41.18+157'", "buildLabel = 'v0.41.19+158'", "buildLabel = 'v0.41.20+159'", "buildLabel = 'v0.41.21+160'", "buildLabel = 'v0.41.22+161'", "buildLabel = 'v0.41.23+162'"
))
