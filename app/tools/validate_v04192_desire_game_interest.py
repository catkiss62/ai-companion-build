...
require("pubspec.yaml", "version: 0.41.92+236")
require("lib/core/agent/agent_self_reader.dart", "v0.41.92+236")
require("lib/core/mcp/mcp_http_client.dart", "'version': '0.41.92'")
require(
